...
<title><?=isset($pagetitle) ? $pagetitle : 'Medical Daily : Daily Medical News and Health News'; ?></title>
<style type="text/css">
<!--
...
$(document).ready(function(){
    $("#menu_sp").hover(function(){
        ...
        $("#dropdown").hide();
        //$("#dropdown").css('visibility','show');
    });
    
    $("#menu_sp").mouseover(function(){
        $("#dropdown").css('visibility','visible');
    });
    $("#menu_sp").mouseout(function(){
...
<div id="wrap">
    ...
    if($bottombox == 'MAINPAGE')
        require(MDconfig::SKINPATH.'/'.$skin.'/header.php');
    else        
        require(MDconfig::SKINPATH.'/'.$skin.'/subheader.php');
    ?>
    <!-- wrap header end -->
    <!-- wrap contents start -->
...
<!-- footer start --> 
    <div id="footer">
        <a href="/">Home</a>  |  <a href="/sections/top-headlines.htm">Top Headlines</a>  |  
        <a href="/sections/healthcare.htm">Healthcare</a>  |  
        <a href="/sections/medical-research.htm">Medical Research</a>  |  
        <a href="/sections/pharma-medicine.htm">Pharma & Medicine</a>  |  
        <a href="/sections/biotech.htm">Biotechnology</a> | 
        <a href="/sections/healthcare.htm">Healthcare</a> | 
        <a href="/sections/fda.htm">FDA</a>  |
        <a href="/sections/healthliving.htm">Healthy Living</a> |
        <a href="/sections/press-release.htm">Press Release</a>  
        <br/>
...
<script type="text/javascript">    __compete_code = 'e775eb25faa5c5749f2ef3de5e0ffd8c';
    (function () {
        var s = document.createElement('script'),
            d = document.getElementsByTagName('head')[0] ||
                document.getElementsByTagName('body')[0],
            t = 'https:' == document.location.protocol ? 
                'https://c.compete.com/bootstrap/' :                 'http://c.compete.com/bootstrap/';        s.src = t + __compete_code + '/bootstrap.js';
