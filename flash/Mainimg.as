package  {
	...
	public class Mainimg extends Sprite {
		...
		public function Mainimg() {
			...
			ds.blurY = 40;
			this.filters = [ds];
			//Tweener.addTween(this, {_Blur_blurX:0,_Blur_blurY:0, time:7});
			*****************************************/
			// constructor code
		...
		public function initTween():void {
			//var t1:ITween = BetweenAS3.tween(_matrixArray,  { 0:0, 1:0, 3:0, 4:1, 5:0, 7:0, 8:0 },{ 0: 0, 1: -1, 3: -1, 4:4, 5:-1, 7:-1, 8:0 }, 2.0, Quad.easeInOut);
			var t1:ITween = BetweenAS3.tween(_matrixArray,  { 0:0, 1:0, 3:0, 4:1, 5:0, 7:0, 8:0 },{ 0: 0, 1: 0, 3: 0, 4:3, 5:0, 7:0, 8:0 }, 2.0, Quad.easeInOut);
