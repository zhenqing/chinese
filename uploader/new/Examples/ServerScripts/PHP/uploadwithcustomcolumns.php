...
if ( count($_FILES) > 0 )
{
	...
	if ( move_uploaded_file( $file['tmp_name'], $uniqueFileName ) )
	{
		...
		if (isset($_POST['file_Share']))
        {
        	echo "Share: " . (($_POST["file_Share"] == "true")?"public":"private") . "<br />";
        }
                
        if (isset($_POST['file_Cover']) && $_POST['file_Cover'] == "on")
        {
            echo "Was chosen as cover of album";
        }		
