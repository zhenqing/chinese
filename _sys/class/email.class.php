<?
define ("SMTPServer", "mail.ibtimes.com");
define ("SMTPUser", "ibt_webmaster");
define ("SMTPPasswd", "sdjflq8929sfj");
define ("webmaEmail", "webmaster@ibtimes.com");
            ...
            if(count($this->MailTo) > 0) {            // 받는 메일이 있으면 다음 작업을 반복한다 
                foreach($this->MailTo as $Email => $Name) { 
                    ...
                    if($this->Socket) { 
                        ...
                        print_r($Result);                        
                        if(strpos($Result, 'Ok') !== false) $Succ++;        // 성공여부판단 
