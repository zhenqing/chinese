        ...
        public function ActionAjaxupdata(){
            ...
            if(is_numeric($upid)){
                ...
                if($_POST){
                    ...
                    $this ->render('elements',array('Model' => $Updatedata,'udata'=>$udata));
         ...
         if(isset($_POST)){
             if(is_numeric($_POST['position_id'])){
                 ...
                 foreach($_POST['Article'] as $k => $v){
                    ...
                    $Updatedata ->title     =  $articleinfo[0]['title'];
                    $Updatedata ->summary   =  Strings::cutString(  $articleinfo[0]['summary'],
                                                                    $positiondata['cut_str_min'],
                                                                    $positiondata['cut_str_max']);
        ...
        public function ActionMakepage(){
            ...
            if(is_numeric($idnum)){
                ...
                foreach($posdata as $pk => $pv){
                   ...
                   foreach($data1 as $v){
                       if($v['img_path']){
                            $v['image'] = '<img src="'.MDconfig::DATA_FOLDER.'/'.$v['img_path'].'"  alt="thumbnail" />';
                       }
                       $data[]     = $v;
                   }
