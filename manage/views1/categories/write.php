...
?>          
           <tr>
            <Td>Special
            	<? 	if(is_array($Model -> data['selectcat'])){
            				$sp_key_array = $Model -> data['selectcat'];
            			}else{
            				$spkeys = $Model -> data['specialkeys']; 
            				$sp_key_array = explode('|',$spkeys);
            		 	}	
            			?>
            	</Td>
            <td><select name="<?=get_class($Model) ?>[selectcat][]" multiple="multiple">
                 <option value="">none</option>
                <?
                    foreach($specialcat as $k => $v){
                    		if(in_array($k,$sp_key_array)){
