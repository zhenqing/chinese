...
?>
          <tr>
            ...
            <!--input type="button" class="btn" name="Edit" value="Edit"  /-->
                <a href="/manage/index.php?r=layouts/edit&id=<?=$val['id'] ?>">Edit</a>
                <input type="button" class="btn" onclick="document.location = '/manage/index.php?r=updatepages/index&id=<?=$val['id'] ?>';"  name="Update" value="Update" />
            </td>
          </tr>
<?    
}   ?>       
